...
public:
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x0640(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Foliage.FoliageInstancedStaticMeshComponent.OnInstanceTakeRadialDamage
	struct FGuid                                       GenerationGuid;                                           // 0x0658(0x0010) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FBodyInstance                               BodyInstance;                                             // 0x0158(0x0130) (Edit)
	...
	unsigned char                                      UnknownData13[0x2];                                       // 0x028A(0x0002) MISSED OFFSET
	unsigned char                                      bRenderCustomDepth : 1;                                   // 0x028C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData14[0x3];                                       // 0x028D(0x0003) MISSED OFFSET
	int                                                CustomDepthStencilValue;                                  // 0x0290(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                TranslucencySortPriority;                                 // 0x0294(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              CollisionRadius;                                          // 0x0298(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ShadeRadius;                                              // 0x029C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                NumSteps;                                                 // 0x02A0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              InitialSeedDensity;                                       // 0x02A4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              AverageSpreadDistance;                                    // 0x02A8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SpreadVariance;                                           // 0x02AC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                SeedsPerStep;                                             // 0x02B0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                DistributionSeed;                                         // 0x02B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxInitialSeedOffset;                                     // 0x02B8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bCanGrowInShade;                                          // 0x02BC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bSpawnsInShade;                                           // 0x02BD(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData15[0x2];                                       // 0x02BE(0x0002) MISSED OFFSET
	float                                              MaxInitialAge;                                            // 0x02C0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxAge;                                                   // 0x02C4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              OverlapPriority;                                          // 0x02C8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FFloatInterval                              ProceduralScale;                                          // 0x02CC(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData16[0x4];                                       // 0x02D4(0x0004) MISSED OFFSET
	struct FRuntimeFloatCurve                          ScaleCurve;                                               // 0x02D8(0x0088) (Edit)
	int                                                ChangeCount;                                              // 0x0360(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	...
	unsigned char                                      UnknownData17[0x2];                                       // 0x0366(0x0002) MISSED OFFSET
	TArray<class URuntimeVirtualTexture*>              RuntimeVirtualTextures;                                   // 0x0368(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                VirtualTextureCullMips;                                   // 0x0378(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	ERuntimeVirtualTextureMainPassType                 VirtualTextureRenderPassType;                             // 0x037C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	class AActor*                                      ActorClass;                                               // 0x0380(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UFoliageInstancedStaticMeshComponent*        ComponentClass;                                           // 0x0398(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
