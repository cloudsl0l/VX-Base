...
// class UMaterial*               InParentMaterial               (Parm, ZeroConstructor, IsPlainOldData)
// class UMaterialInstanceDynamic* ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

class UMaterialInstanceDynamic* USubstanceGraphInstance::GetDynamicMaterialInstance(const struct FName& Name, class UMaterial* InParentMaterial)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function SubstanceCore.SubstanceGraphInstance.GetDynamicMaterialInstance");

	USubstanceGraphInstance_GetDynamicMaterialInstance_Params params;
	params.Name = Name;
...
TArray<class UTexture2D*> USubstanceUtility::STATIC_GetSubstanceTextures(class USubstanceGraphInstance* GraphInstance)
{
	static UFunction* fn = NULL;
	if(!fn)
...
// class UMaterial*               ParentMaterial                 (Parm, ZeroConstructor, IsPlainOldData)
// struct FString                 InstanceName                   (Parm, ZeroConstructor)
// class USubstanceGraphInstance* ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

class USubstanceGraphInstance* USubstanceUtility::STATIC_CreateGraphInstance(class UObject* WorldContextObject, class USubstanceInstanceFactory* Factory, int GraphDescIndex, class UMaterial* ParentMaterial, const struct FString& InstanceName)
{
	static UFunction* fn = NULL;
	if(!fn)
