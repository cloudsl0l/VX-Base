...
{
public:
	struct FCameraLookatTrackingSettings               LookatTrackingSettings;                                   // 0x07B0(0x0050) (Edit, BlueprintVisible)
...
{
public:
	struct FCameraFilmbackSettings                     FilmbackSettings;                                         // 0x07D0(0x000C) (Deprecated)
	struct FCameraFilmbackSettings                     Filmback;                                                 // 0x07DC(0x000C) (Edit, BlueprintVisible)
	struct FCameraLensSettings                         LensSettings;                                             // 0x07E8(0x0018) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FCameraFocusSettings                        FocusSettings;                                            // 0x0800(0x0058) (Edit, BlueprintVisible)
	float                                              CurrentFocalLength;                                       // 0x0858(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CurrentAperture;                                          // 0x085C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CurrentFocusDistance;                                     // 0x0860(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	...
	struct FString                                     DefaultFilmbackPresetName;                                // 0x0890(0x0010) (ZeroConstructor, Config, Deprecated)
	struct FString                                     DefaultFilmbackPreset;                                    // 0x08A0(0x0010) (ZeroConstructor, Config)
