...
// WidgetBlueprintGeneratedClass PlayerEquipSlotTatic.PlayerEquipSlotTatic_C
// 0x0008 (0x03C0 - 0x03B8)
class UPlayerEquipSlotTatic_C : public UPDPlayerEquipmentSlotMulti
{
public:
	...
	static UClass* StaticClass()
	{
		...
		if(!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass PlayerEquipSlotTatic.PlayerEquipSlotTatic_C");
