...
{
public:
	class UUserWidget*                                 EntryWidgetClass;                                         // 0x01C8(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bAllowTemplate : 1;                                       // 0x0330(0x0001)
	unsigned char                                      bAllowDynamicCreation : 1;                                // 0x0330(0x0001)
	unsigned char                                      bValidTemplate : 1;                                       // 0x0330(0x0001)
	unsigned char                                      bTemplateInitialized : 1;                                 // 0x0330(0x0001) (Transient)
	unsigned char                                      bCookedTemplate : 1;                                      // 0x0330(0x0001) (Transient)
	...
	unsigned char                                      UnknownData01[0x28];                                      // 0x0368(0x0028) UNKNOWN PROPERTY: SoftObjectProperty UMG.WidgetBlueprintGeneratedClass.TemplateAsset
...
{
public:
	class UUserWidget*                                 WidgetClass;                                              // 0x0440(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   DrawSize;                                                 // 0x0448(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bManuallyRedraw;                                          // 0x0450(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRedrawRequested;                                         // 0x0451(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	bool                                               bDrawAtDesiredSize;                                       // 0x0468(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bReceiveHardwareInput;                                    // 0x0474(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bWindowFocusable;                                         // 0x0475(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EWindowVisibility                                  WindowVisibility;                                         // 0x0476(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bApplyGammaCorrection;                                    // 0x0477(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bIsTwoSided;                                              // 0x04A5(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               TickWhenOffscreen;                                        // 0x04A6(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x04A7(0x0001) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0x20];                                      // 0x04B0(0x0020) MISSED OFFSET
	...
	bool                                               bAddedToScreen;                                           // 0x0518(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bEditTimeUsable;                                          // 0x0519(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x2];                                       // 0x051A(0x0002) MISSED OFFSET
