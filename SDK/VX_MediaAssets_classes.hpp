...
public:
	...
	unsigned char                                      UnknownData03[0x1D8];                                     // 0x06F8(0x01D8) MISSED OFFSET
...
public:
	...
	bool                                               EnableGenMips;                                            // 0x016C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      NumMips;                                                  // 0x016D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x016E(0x0002) MISSED OFFSET
	class UMediaPlayer*                                MediaPlayer;                                              // 0x0170(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xB8];                                      // 0x0178(0x00B8) MISSED OFFSET
