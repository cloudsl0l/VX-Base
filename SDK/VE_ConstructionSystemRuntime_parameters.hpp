...
{
	EConstructionSystemToolType                        InToolType;                                               // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	EConstructionSystemToolType                        ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
