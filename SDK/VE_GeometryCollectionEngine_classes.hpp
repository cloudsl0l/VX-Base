...
public:
	...
	unsigned char                                      UnknownData04[0x10];                                      // 0x02E0(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty GeometryCollectionEngine.ChaosDestructionListener.OnCollisionEvents
	unsigned char                                      UnknownData05[0x10];                                      // 0x02F0(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty GeometryCollectionEngine.ChaosDestructionListener.OnBreakingEvents
	unsigned char                                      UnknownData06[0x10];                                      // 0x0300(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty GeometryCollectionEngine.ChaosDestructionListener.OnTrailingEvents
	unsigned char                                      UnknownData07[0x110];                                     // 0x0310(0x0110) MISSED OFFSET
...
// 0x0440 (0x0880 - 0x0440)
class UGeometryCollectionComponent : public UMeshComponent
{
public:
	class AChaosSolverActor*                           ChaosSolverActor;                                         // 0x0440(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xE0];                                      // 0x0448(0x00E0) MISSED OFFSET
	class UGeometryCollection*                         RestCollection;                                           // 0x0528(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoClear, IsPlainOldData)
	TArray<class AFieldSystemActor*>                   InitializationFields;                                     // 0x0530(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoClear)
	bool                                               Simulating;                                               // 0x0540(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0541(0x0007) MISSED OFFSET
	EObjectStateTypeEnum                               ObjectType;                                               // 0x0548(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               EnableClustering;                                         // 0x0549(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x054A(0x0002) MISSED OFFSET
	int                                                ClusterGroupIndex;                                        // 0x054C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxClusterLevel;                                          // 0x0550(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0554(0x0004) MISSED OFFSET
	TArray<float>                                      DamageThreshold;                                          // 0x0558(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	EClusterConnectionTypeEnum                         ClusterConnectionType;                                    // 0x0568(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0569(0x0003) MISSED OFFSET
	int                                                CollisionGroup;                                           // 0x056C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CollisionSampleFraction;                                  // 0x0570(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LinearEtherDrag;                                          // 0x0574(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              AngularEtherDrag;                                         // 0x0578(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x057C(0x0004) MISSED OFFSET
	class UChaosPhysicalMaterial*                      PhysicalMaterial;                                         // 0x0580(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	EInitialVelocityTypeEnum                           InitialVelocityType;                                      // 0x0588(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x0589(0x0003) MISSED OFFSET
	struct FVector                                     InitialLinearVelocity;                                    // 0x058C(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     InitialAngularVelocity;                                   // 0x0598(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x4];                                       // 0x05A4(0x0004) MISSED OFFSET
	struct FGeomComponentCacheParameters               CacheParameters;                                          // 0x05A8(0x0050) (Edit)
	unsigned char                                      UnknownData08[0x10];                                      // 0x05F8(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty GeometryCollectionEngine.GeometryCollectionComponent.NotifyGeometryCollectionPhysicsStateChange
	unsigned char                                      UnknownData09[0x10];                                      // 0x0608(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty GeometryCollectionEngine.GeometryCollectionComponent.NotifyGeometryCollectionPhysicsLoadingStateChange
	unsigned char                                      UnknownData10[0x18];                                      // 0x0618(0x0018) MISSED OFFSET
	unsigned char                                      UnknownData11[0x10];                                      // 0x0618(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty GeometryCollectionEngine.GeometryCollectionComponent.OnChaosBreakEvent
	float                                              DesiredCacheTime;                                         // 0x0640(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Transient, EditConst, IsPlainOldData)
	bool                                               CachePlayback;                                            // 0x0644(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, EditConst, IsPlainOldData)
	unsigned char                                      UnknownData12[0x3];                                       // 0x0645(0x0003) MISSED OFFSET
	unsigned char                                      UnknownData13[0x10];                                      // 0x0645(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty GeometryCollectionEngine.GeometryCollectionComponent.OnChaosPhysicsCollision
	bool                                               bNotifyBreaks;                                            // 0x0658(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bNotifyCollisions;                                        // 0x0659(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x1FE];                                     // 0x065A(0x01FE) MISSED OFFSET
	class UBodySetup*                                  DummyBodySetup;                                           // 0x0858(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
