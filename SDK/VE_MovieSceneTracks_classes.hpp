...
{
public:
	struct FMovieSceneActorReferenceData               ActorReferenceData;                                       // 0x00E0(0x00B0)
	struct FIntegralCurve                              ActorGuidIndexCurve;                                      // 0x0190(0x0080) (Deprecated)
	TArray<struct FString>                             ActorGuidStrings;                                         // 0x0210(0x0010) (ZeroConstructor, Deprecated)
...
public:
	...
	struct FMovieSceneActorReferenceData               AttachActorData;                                          // 0x0240(0x00B0)
	bool                                               bSuppressSubtitles;                                       // 0x02F0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideAttenuation;                                     // 0x02F1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x6];                                       // 0x02F2(0x0006) MISSED OFFSET
	class USoundAttenuation*                           AttenuationSettings;                                      // 0x02F8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FScriptDelegate                             OnQueueSubtitles;                                         // 0x0300(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0310(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty MovieSceneTracks.MovieSceneAudioSection.OnAudioFinished
	unsigned char                                      UnknownData03[0x10];                                      // 0x0320(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty MovieSceneTracks.MovieSceneAudioSection.OnAudioPlaybackPercent
...
{
public:
	bool                                               bCanBlend;                                                // 0x0058(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UCameraShake*                                ShakeClass;                                               // 0x0100(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
...
{
public:
	struct FMovieSceneEvent                            Event;                                                    // 0x00E0(0x0028) (Edit)
...
{
public:
	class UObject*                                     PropertyClass;                                            // 0x0088(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	TArray<struct FBoolParameterNameAndCurve>          BoolParameterNamesAndCurves;                              // 0x00E0(0x0010) (ZeroConstructor)
	TArray<struct FScalarParameterNameAndCurve>        ScalarParameterNamesAndCurves;                            // 0x00F0(0x0010) (ZeroConstructor)
	TArray<struct FVector2DParameterNameAndCurves>     Vector2DParameterNamesAndCurves;                          // 0x0100(0x0010) (ZeroConstructor)
	TArray<struct FVectorParameterNameAndCurves>       VectorParameterNamesAndCurves;                            // 0x0110(0x0010) (ZeroConstructor)
	TArray<struct FColorParameterNameAndCurves>        ColorParameterNamesAndCurves;                             // 0x0120(0x0010) (ZeroConstructor)
	TArray<struct FTransformParameterNameAndCurves>    TransformParameterNamesAndCurves;                         // 0x0130(0x0010) (ZeroConstructor)
