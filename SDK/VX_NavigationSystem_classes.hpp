...
public:
	...
	unsigned char                                      UnknownData03[0xE0];                                      // 0x02B8(0x00E0) MISSED OFFSET
...
public:
	...
	TArray<struct FNavigationLink>                     Links;                                                    // 0x0418(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	float                                              AgentMaxHeight;                                           // 0x0424(0x0004) (Edit, ZeroConstructor, Config, EditConst, IsPlainOldData)
