...
public:
	...
	unsigned char                                      UnknownData01[0x128];                                     // 0x0140(0x0128) MISSED OFFSET
	class UBehaviorTree*                               DefaultBehaviorTreeAsset;                                 // 0x0268(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData01[0xB8];                                      // 0x00F8(0x00B8) MISSED OFFSET
