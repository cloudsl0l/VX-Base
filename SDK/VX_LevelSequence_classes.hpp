...
public:
	...
	TMap<struct FString, struct FLevelSequenceObject>  PossessedObjects;                                         // 0x0440(0x0050) (Deprecated)
	class UObject*                                     DirectorClass;                                            // 0x0490(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	TArray<class AActor*>                              AdditionalEventReceivers;                                 // 0x0268(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FLevelSequenceCameraSettings                CameraSettings;                                           // 0x0278(0x0002) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData02[0x6];                                       // 0x027A(0x0006) MISSED OFFSET
	class ULevelSequenceBurnInOptions*                 BurnInOptions;                                            // 0x0280(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UMovieSceneBindingOverrides*                 BindingOverrides;                                         // 0x0288(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      bAutoPlay : 1;                                            // 0x0290(0x0001) (Deprecated)
	unsigned char                                      bOverrideInstanceData : 1;                                // 0x0290(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bReplicatePlayback : 1;                                   // 0x0290(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData03[0x7];                                       // 0x0291(0x0007) MISSED OFFSET
	class UObject*                                     DefaultInstanceData;                                      // 0x0298(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class ULevelSequenceBurnIn*                        BurnInInstance;                                           // 0x02A0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	bool                                               bShowBurnin;                                              // 0x02A8(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0888(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty LevelSequence.LevelSequencePlayer.OnCameraCut
