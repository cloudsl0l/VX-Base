...
public:
	...
	unsigned char                                      UnknownData00[0x69C];                                     // 0x06D4(0x069C) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x34];                                      // 0x0040(0x0034) MISSED OFFSET
	struct FSourceEffectMidSideSpreaderSettings        Settings;                                                 // 0x0074(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly)
...
public:
	unsigned char                                      UnknownData00[0x30];                                      // 0x0040(0x0030) MISSED OFFSET
	struct FSourceEffectPannerSettings                 Settings;                                                 // 0x0070(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly)
...
{
public:
	struct FSubmixEffectConvolutionReverbSettings      Settings;                                                 // 0x0040(0x0020) (Edit, BlueprintVisible)
	class UAudioImpulseResponse*                       ImpulseResponse;                                          // 0x0060(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	ESubmixEffectConvolutionReverbBlockSize            BlockSize;                                                // 0x0068(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableHardwareAcceleration;                              // 0x0069(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
