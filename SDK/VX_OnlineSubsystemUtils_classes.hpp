...
{
public:
	unsigned char                                      UnknownData00[0x50];                                      // 0x1A30(0x0050) MISSED OFFSET
	float                                              SocketErrorDisconnectDelay;                               // 0x1A80(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4C];                                      // 0x1A84(0x004C) MISSED OFFSET
